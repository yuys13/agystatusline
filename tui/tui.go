...
var widgetTypes = []struct {
	...
	{name: "Quota %: Gemini 5h", wType: "quota", color: "brightBlack", metadata: map[string]string{"key": "gemini-5h", "display": "quota"}},
	{name: "Quota %: Gemini Weekly", wType: "quota", color: "brightBlack", metadata: map[string]string{"key": "gemini-weekly", "display": "quota"}},
	{name: "Quota %: 3P 5h", wType: "quota", color: "brightBlack", metadata: map[string]string{"key": "3p-5h", "display": "quota"}},
	{name: "Quota %: 3P Weekly", wType: "quota", color: "brightBlack", metadata: map[string]string{"key": "3p-weekly", "display": "quota"}},
	{name: "Quota Reset: Gemini 5h", wType: "quota", color: "brightBlack", metadata: map[string]string{"key": "gemini-5h", "display": "reset"}},
